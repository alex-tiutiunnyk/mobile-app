...
sealed class MarkersData(val route: String, val position: LatLng, val occupied: Int? = null, val capacity: Int, val pricePerHour: Double? = null, val isForDisabledPerson: Boolean = false, val isForElectricCar: Boolean = false) { //ad the list of comments as well
